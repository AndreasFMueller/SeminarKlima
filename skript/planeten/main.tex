...
$\xi_2$ & $16 \cdot 10^{-3}$	& Koefffizient Wasserdampfbildung\\
$\xi_3$ & $2.6 \cdot 10^{0}$	& Koefffizient Wolkenbildung \\
$\xi_4$ & $5   \cdot 10^{0}$	& Koefffizient Wolkenabbau \\
$\beta_{\text{max}}$ & $0.5$	& Maximaler Anteil der durch den Treibhauseffekt zurückgehalteten Leisung
	\end{tabular}
