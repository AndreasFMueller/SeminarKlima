...
\begin{figure}
	\begin{center}$
		\begin{array}{cc}
			\includegraphics[width=0.5\linewidth]{lorenz/assets/lorenz-modell/lorenz09.pdf} &
			\includegraphics[width=0.5\linewidth]{lorenz/assets/lorenz-modell/lorenz10.pdf}
		\end{array}$
