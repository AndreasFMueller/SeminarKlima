...
Messdaten und
ein Modell des untersuchten Systems ermöglichen, selbst dann einigermassen
...
Das System und der Messprozess mussten linear beschreibbar sein, 
...
ändert, wenn $Y$ den Wert $y$  annimmt.
...
\end{align*}
Wir erhalten damit die Formel~\eqref{assim:totalstep2} für $i=2$.
...
Reanalyse-Problem dieselbe wie jene für das Filterproblem.
