...
\begin{figure}
\centering
\includegraphics{chapters/2/fe.pdf}
\caption{Approximationsfunktionen für stückweise lineare Funktionen 
mit Hilfe $h_i(x)$ und eine Familie glatter Funktionen $H_i(x)$ für
den gleichen Zweck.
...
Abbildung~\ref{skript:finiteelmente} rechts ersetzt.
