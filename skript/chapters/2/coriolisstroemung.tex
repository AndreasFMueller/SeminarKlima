...
\rhead{Strömung und Coriolis-Effekt}
...
Die $x$-Koordinaten verläuft also entlang der Breitenkreise, die 
$y$-Koordinate entlang der Längenkreise.
\index{$\beta$-Ebene}%
...
Wir sollten also in der Lage sein, für geeignete Anfangsbedingungen eine 
Lösung zu finden.
...
eine nordwärts gerichtete Strömung ablesen, dass $u(y)$ mit zunehmendem
$y$ nur zunehmen kann.
